...
const Domaine = () => {
  ...
  return (
    <div className="page-domaine">
      ...
      <h1 className="uppercase white"><Trans i18nKey="domaine.h1-01">Découvrez tout ce que le domaine avalon carp a à vous offrir.</Trans></h1>
      ...
      <div className="text-center flex justify-center flex-col">
        <h1 className="text-center w-6/12 mx-auto"><Trans i18nKey="domaine.decouvrez-photos">DÉCOUVREZ <strong>LES PLUS BELLES PHOTOS</strong> DE AVALON CARP LAKE :</Trans></h1>
