        ...
        <div className="container-full">
          <div className="lg:columns-3 md:columns-1">
            <div class="reglement-item">
              ...
              <div>
                <h3>Horaires de prise et départ des postes</h3>
                <p>Prise des postes entre 14h et 17h30. Départ entre 9H et 12H00. Aucun départ ou arrivée ne sera autorisé entre 17H30 et 9H. Merci de prendre vos dispositions. Les semaines de pêche se déroulent du samedi au samedi suivant. Possibilité de séjour sur mesure, nous consulter pour plus d’informations. </p>
              </div>
            </div>
            ...
            <div class="reglement-item">
              ...
              <div>
                <h3>Confort</h3>
                <p>Des cabanes de pêche en bois de 6m2 avec dalle au sol sont mises à disposition sur chacun des 6 postes du plan d’eau. Un état des lieux sera effectué lors de l’arrivée et du départ du pêcheur. Sanitaires (douche, toilettes) sont mis à votre disposition 24h/24h et 7j/7j. Merci de tenir propre ces lieux et de veiller à votre consommation d’eau par respect pour les autres usagers. Seuls les biwy et parapluies-tente de couleur verte ou camouflage sont acceptés. </p>
              </div>
            </div>
            ...
            <div class="reglement-item">
              ...
              <div>
                <h3>véhicules</h3>
                <p>Les véhicules devront être stationnés sur les parkings prévus à cet effet. Interdiction de stationner les véhicules sur les postes. Des charriots sont mis à disposition pour le transfert de matériel sur les postes. </p>
              </div>
            </div>
            ...
            <div class="reglement-item">
              ...
              <div>
                <h3>accompagnants</h3>
                <p>2 accompagnants maximum par pêcheur, gratuit pour les enfants de moins de 12ans. Les accompagnants devront prendre connaissance et respecter le règlement du site. </p>
              </div>
            </div>
            ...
            <div class="reglement-item">
              ...
              <div>
                <h3>feu/barbecue </h3>
                <p>Seuls les barbecues sur pied et à gaz sont tolérés (feux au sol interdits). Les cendres froides devront être évacuées dans un sac poubelle et emportées en fin de session. </p>
              </div>
            </div>
            ...
            <div class="reglement-item">
              ...
              <div>
                ...
                <p>Les postes de pêche seront maintenus propres. Chaque pêcheur est responsable des ses déchets. Il est formellement interdit de jeter des déchets et mégots de cigarettes par terre ou dans le lac. Le poste doit être propre et sans sac poubelle à votre départ ou la caution sera retenue. </p>
              </div>
            </div>
            ...
            <div class="reglement-item">
              ...
              <div>
                <h3>Chiens et animaux domestiques</h3>
                <p>Un chien maximum par pêcheur est toléré mais ne devra créer aucune gêne pour les autres pêcheurs (aboiements, agressivité...) et devra être tatoué ou pucé, vacciné et assuré en responsabilité civile. Il devra être tenu en laisse et sous surveillance constante. Interdiction formelle que le chien se baigne ; les excréments devront être ramassés ou la caution pourra être retenue.</p>
              </div>
            </div>

            <div className="uppercase text-right">
              <h2 className="bold">besoin de<br/>précisions ?</h2>
              <a href="#">
                <button class="cta cta-green">CONTACTEZ-NOUS</button>  
              </a>
            </div>
          </div>
        </div>
